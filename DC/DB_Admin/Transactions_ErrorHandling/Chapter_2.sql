...
-- Throw statement
	-- Throw statement is best practice
...
-- Another example with stored procedure
...
-- Custom throw with custom error code
...
-- Another example with formatmessage
